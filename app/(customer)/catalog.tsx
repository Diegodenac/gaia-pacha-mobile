...
export default function CatalogScreen() {
  ...
  // AQUÍ LLAMAMOS AL ALGORITMO: Le pasamos id_customer = 1
  const { data, isLoading, refetch } = useCatalogQuery({ id_customer: 1 });

  const products = data?.data || [];

  // FUNCIÓN 1: Para recargar al deslizar hacia abajo (Pull-to-refresh)
  ...
  // FUNCIÓN 2: Para recargar automáticamente al entrar a esta pestaña
  useFocusEffect(
    useCallback(() => {
      if (refetch) {
        refetch();
